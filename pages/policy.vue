<template>
  <div class="policy">
    ...
    <h2 class="policy__subtitle">1. Общие положения.</h2>
    <p class="policy__paragraph policy__text">
    ...
    <ol class="policy__pagagraph-list policy__text">
      ...
      <li class="list-item">Электронный адрес;</li>
      <li class="list-item">Номера телефонов;</li>
      <li class="list-item">Год, месяц, дата и место рождения;</li>
      <li class="list-item">Фотографии;</li>
      <li class="list-item">
    ...
    <ol class="policy__pagagraph-list policy__text">
      ...
      <li class="list-item">
        ...
        электронный адрес Оператора raklechitsa@bfkh.ru с пометкой «Отзыв
    ...
    <ol class="policy__pagagraph-list policy__text">
      <li class="list-item">
        ...
        помощью электронной почты raklechitsa@bfkh.ru.
      </li>
      <li class="list-item">
